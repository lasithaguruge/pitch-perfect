...
/**
 * A basic additive synthesis jMusic instrument implementation which implements
 * envelope and volume control
 *
...
public final class SineInst extends jm.audio.Instrument {
    ...
    //----------------------------------------------
    /**
     * Basic default constructor that creates a stereo signal at 44100 hz.
     */
    public SineInst() {
        this(44100, 2);
    }
    ...
    /**
     * A constructor to set sampleRate, channels, and the pitch of the sine wave
     * in hertz.
     *
     * @param sampleRate
     * @param channels the number of channels in the sound 1 = mono, 2 = stereo,
    ...
    /**
     * Initialisation method used to build the objects that this instrument will
     * use.
     */
